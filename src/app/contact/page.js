export default function Contact() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-yellow-50 to-orange-100 dark:from-black dark:to-black">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">cseamed01@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">+88 01795825188</p>
                  </div>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="https://nasimahamed.com" className="text-indigo-600 dark:text-indigo-400 hover:underline">nasimahamed.com</a>
                  </div>
                </div>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-gray-100 dark:bg-gray-900 rounded-full flex items-center justify-center mr-4">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/cseahmed01" className="text-indigo-600 dark:text-indigo-400 hover:underline">github.com/cseahmed01</a>
                  </div>
                </div>
              </div>
            </div>
